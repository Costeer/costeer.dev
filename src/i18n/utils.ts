 ...
 *   localizedPath('/posts/foo', 'de') -> '/de/posts/foo'
 *   localizedPath('/', 'de')          -> '/de/'
 *
 ...
 * Anything starting with a configured non-default locale prefix resolves to
 * that locale; otherwise the default locale is returned.
 */
 ...
 *
 *   stripLocale('/de/posts/foo')  -> '/posts/foo'
 ...
 * (e.g. '/posts/welcome' for both EN and DE). Pass `availableLocales` to
